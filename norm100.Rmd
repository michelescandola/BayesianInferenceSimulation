# Priors are normal distributions with mean 0 and standard deviation 100
...
```{r}
graph1 = read.csv2("/norm100/IVS_1.csv",dec=".")
colnames(graph1) = c("X","BF","iteration")
graph1$hypothesis = "alternative"

graph2 = read.csv2("/norm100/IVS_0.csv",dec=".")
...
```{r}
graph1 = read.csv2("/norm100/BFS_1.csv",dec=".")
colnames(graph1) = c("X","BF","iteration")
graph1$hypothesis = "alternative"

graph2 = read.csv2("/norm100/BFS_0.csv",dec=".")
colnames(graph2) = c("X","BF","iteration")
graph2$hypothesis = "null"
...
```{r}
graph1 = read.csv2("/norm100/SD_1.csv",dec=".")
colnames(graph1) = c("X","BF","iteration")
graph1$hypothesis = "alternative"

graph2 = read.csv2("/norm100/SD_0.csv",dec=".")
colnames(graph2) = c("X","BF","iteration")
graph2$hypothesis = "null"
...
```{r}
graph1 = read.csv2("/norm100/WAIC_1.csv",dec=".")
colnames(graph1) = c("X","compare","Waic","Error","iteration")
graph1$hypothesis = "alternative"

graph2 = read.csv2("/norm100/WAIC_0.csv",dec=".")
