# Priors are normal distributions with mean 0 and standard deviation 1
...
for(i in 1:n_iterations){
  ...
  mdl <- R2jags::jags(data=datalist,parameters.to.save = "iota", model.file = "norm001/IVS.jags",
                      n.iter= 11000, n.chains = 2, n.burnin = 1000, jags.seed = i)
  
  iotas[[i]] = mean(mdl$BUGSoutput$sims.matrix[,"iota"])
  write.table(file="norm001/IVS_1.csv",x=data.frame(iotas[[i]], i),append = TRUE,sep=";",col.names = FALSE)
}
...
for(i in 1:n_iterations){
  ...
  write.table(file="norm001/IVS_0.csv",x=data.frame(iotan[[i]], i),append = TRUE,sep=";",col.names = FALSE)
}
...
```{r}
graph1 = read.csv2("norm001/IVS_1.csv",dec=".")
colnames(graph1) = c("X","BF","iteration")
graph1$hypothesis = "alternative"

graph2 = read.csv2("norm001/IVS_0.csv",dec=".")
...
for(i in 1:n_iterations){
  ...
  mdlH1 <- R2jags::jags(data=datalist1,parameters.to.save = c("alpha","beta","sigma"), model.file = "norm001/mdl_H1.jags",
                        n.iter= 11000, n.chains = 2, n.burnin = 1000, jags.seed = i)
  
  mdlH0 <- R2jags::jags(data=datalist2,parameters.to.save = c("alpha","sigma"), model.file = "norm001/mdl_H0.jags",
                        n.iter= 11000, n.chains = 2, n.burnin = 1000, jags.seed = i)
  ...
  write.table(file="norm001/BFS_1.csv",x=data.frame(bfs1[[i]], i),append = TRUE,sep=";",col.names = FALSE)
  ...
  mdlH1 <- R2jags::jags(data=datalist3,parameters.to.save = c("alpha","beta","sigma"), model.file = "norm001/mdl_H1.jags",
                        n.iter= 11000, n.chains = 2, n.burnin = 1000, jags.seed = i)
  
  mdlH0 <- R2jags::jags(data=datalist4,parameters.to.save = c("alpha","sigma"), model.file = "norm001/mdl_H0.jags",
                        n.iter= 11000, n.chains = 2, n.burnin = 1000, jags.seed = i)
  ...
  write.table(file="norm001/BFS_0.csv",x=data.frame(bfs0[[i]], i),append = TRUE,sep=";",col.names = FALSE)
}
...
```{r}
graph1 = read.csv2("norm001/BFS_1.csv",dec=".")
colnames(graph1) = c("X","BF","iteration")
graph1$hypothesis = "alternative"

graph2 = read.csv2("norm001/BFS_0.csv",dec=".")
colnames(graph2) = c("X","BF","iteration")
graph2$hypothesis = "null"
...
model {
  ...
  for (i in 1:N) {  
    ...
    log_like[i] <- logdensity.norm(y[i], mu[i], 1/sigma)
  }
...
for(i in 1:n_iterations){
  ...
  mdlH1 <- R2jags::jags(data=datalist1,parameters.to.save = "beta", model.file = "norm001/mdl_H1.jags",
                        n.iter= 11000, n.chains = 2, n.burnin = 1000, jags.seed = i)
  
  bfs1[[i]] <- Savage_Dickey(mdlH1)
  write.table(file="norm001/SD_1.csv",x=data.frame(bfs1[[i]], i),append = TRUE,sep=";",col.names = FALSE)
  ...
  mdlH0 <- R2jags::jags(data=datalist2,parameters.to.save = "beta", model.file = "norm001/mdl_H1.jags",
                        n.iter= 11000, n.chains = 2, n.burnin = 1000, jags.seed = i)
  
  bfs0[[i]] <- Savage_Dickey(mdlH0)
  write.table(file="norm001/SD_0.csv",x=data.frame(bfs0[[i]], i),append = TRUE,sep=";",col.names = FALSE)
}
...
```{r}
graph1 = read.csv2("norm001/SD_1.csv",dec=".")
colnames(graph1) = c("X","BF","iteration")
graph1$hypothesis = "alternative"

graph2 = read.csv2("norm001/SD_0.csv",dec=".")
colnames(graph2) = c("X","BF","iteration")
graph2$hypothesis = "null"
...
for(i in 1:n_iterations){
  ...
  mdlH1 <- R2jags::jags(data=datalist1,parameters.to.save = "log_like", model.file = "norm001/log_like_H1.jags",
                        n.iter= 11000, n.chains = 2, n.burnin = 1000, jags.seed = i)
  ...
  mdlH0 <- R2jags::jags(data=datalist2,parameters.to.save = "log_like", model.file = "norm001/log_like_H0.jags",
                        n.iter= 11000, n.chains = 2, n.burnin = 1000, jags.seed = i)
  ...
  waic1[[i]] <- ww[1]/ww[[2]]
  write.table(file="norm001/WAIC_1.csv",x=data.frame(waic1[[i]],ww[1],ww[2], i),append = TRUE,sep=";",col.names = FALSE)
  ...
  mdlH1 <- R2jags::jags(data=datalist3,parameters.to.save = "log_like", model.file = "norm001/log_like_H1.jags",
                        n.iter= 11000, n.chains = 2, n.burnin = 1000, jags.seed = i)
  ...
  mdlH0 <- R2jags::jags(data=datalist4,parameters.to.save = "log_like", model.file = "norm001/log_like_H0.jags",
                        n.iter= 11000, n.chains = 2, n.burnin = 1000, jags.seed = i)
  ...
  waic0[[i]] <- ww[1]/ww[[2]]
  write.table(file="norm001/WAIC_0.csv",x=data.frame(waic0[[i]],ww[1],ww[2], i),append = TRUE,sep=";",col.names = FALSE)
}
...
```{r}
graph1 = read.csv2("norm001/WAIC_1.csv",dec=".")
colnames(graph1) = c("X","compare","Waic","Error","iteration")
graph1$hypothesis = "alternative"

graph2 = read.csv2("norm001/WAIC_0.csv",dec=".")
